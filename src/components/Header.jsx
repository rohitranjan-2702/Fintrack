        ...
        <div className="flex flex-wrap items-center justify-between px-6 py-4">
          ...
          >
            <img
              ...
              className="mr-3 h-14"
            />
            <a href="/" className="hidden text-lg font-semibold text-gray-800 sm:block">
              {" "}
              FinanceAPP{" "}
            </a>
          </div>
          <div className="flex">
            ...
            {isLoggedIn ? (
              <div>
                <button
                  className="text-md px-6 py-3 font-semibold text-gray-600 transition-all hover:text-blue-700 disabled:bg-gray-400"
                  onClick={() => {
                    navigate("/dashboard");
                  }}
                >
