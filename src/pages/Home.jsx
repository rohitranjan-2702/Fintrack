        ...
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center">
            ...
            <div className="lg:w-1/2 ">
              ...
              <p className="w-full font-poppins font-[400] text-black mb-4 lg:p-0 p-5">
                One stop solution for budget, manage expenses and invest your savings. Take control of your finances and secure your future with ease.
              </p>
